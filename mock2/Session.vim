...
set shortmess=aoO
badd +8 app/views/shops/index.html.erb
badd +16 app/views/shops/show.html.erb
badd +78 app/controllers/shops_controller.rb
badd +2 app/models/prefecture.rb
badd +4 app/models/branch.rb
badd +2 app/models/shop.rb
badd +1 db/seeds.rb
badd +40 db/schema.rb
badd +2 app/views/shops/_choices.html.erb
badd +4 app/views/layouts/application.html.erb
badd +17 app/assets/stylesheets/application.css
badd +36 app/assets/stylesheets/shops.scss
badd +0 app
badd +14 NERD_tree_2
argglobal
silent! argdel *
argadd app
set stal=2
edit app/views/shops/_choices.html.erb
...
19
normal! 011|
lcd ~/Desktop/github/select-shop-map/mock2
wincmd w
exe 'vert 1resize ' . ((&columns * 30 + 106) / 212)
exe 'vert 2resize ' . ((&columns * 181 + 106) / 212)
tabedit ~/Desktop/github/select-shop-map/mock2/app/assets/stylesheets/shops.scss
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
argglobal
enew
file ~/Desktop/github/select-shop-map/mock2/NERD_tree_2
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <silent> <NL> :call nerdtree#ui_glue#invokeKeyMap("<C-j>")
nnoremap <buffer> <silent>  :call nerdtree#ui_glue#invokeKeyMap("<C-k>")
...
exe 'vert 1resize ' . ((&columns * 31 + 106) / 212)
exe 'vert 2resize ' . ((&columns * 180 + 106) / 212)
tabedit ~/Desktop/github/select-shop-map/mock2/app/controllers/shops_controller.rb
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
argglobal
enew
file ~/Desktop/github/select-shop-map/mock2/NERD_tree_3
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <silent> <NL> :call nerdtree#ui_glue#invokeKeyMap("<C-j>")
nnoremap <buffer> <silent>  :call nerdtree#ui_glue#invokeKeyMap("<C-k>")
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 32 - ((28 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
