...
set shortmess=aoO
badd +1 app/views/shops/index.html.erb
badd +0 app/views/shops/show.html.erb
badd +0 app/controllers/shops_controller.rb
badd +2 app/models/prefecture.rb
badd +4 app/models/branch.rb
badd +2 app/models/shop.rb
badd +7 db/seeds.rb
badd +31 db/schema.rb
badd +0 app/views/shops/_choices.html.erb
badd +11 app/views/layouts/application.html.erb
badd +17 app/assets/stylesheets/application.css
badd +8 app/assets/stylesheets/shops.scss
argglobal
silent! argdel *
argadd app
set stal=2
...
wincmd w
argglobal
edit ~/Desktop/github/select-shop-map/mock2/app/views/shops/_choices.html.erb
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> gf <Plug>RailsTabFind
nmap <buffer>  <Plug>RailsSplitFind
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 76 - ((29 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
76
